...
(function ($) {
    var w2grid = function(options) {
        ...
        this.textSearch      = 'contains'; // default search type for text (is, begins, contains, ends) kkmodified
    ...
    w2popup = {
        ...
        close: function (options) {
            ...
            setTimeout(function () {
                ...
                // restore active
                if (options._last_focus.length > 0) //options._last_focus.focus(); kkmodified
                // event after
                obj.trigger($.extend(edata, { phase: 'after'}));
            }, options.speed * 1000);
